...
import './Form.css'
import { emit } from '../../../../aula 677/backEnd/models/Party'
  ...
  return (
    <div className='form-page'>
      ...
      <form onSubmit={(e) => CreateParty(e)}>
        ...
        <label>
          <span>Orçamento:</span>
          <input type="number" placeholder='Quanto você deseja investir?' required onChange={(e) => setBudget(e.target.value)} value={budget} />
        </label>
        <label>
          <span>Imagem:</span>
